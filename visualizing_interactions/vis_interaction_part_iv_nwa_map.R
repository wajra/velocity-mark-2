...
sum <- aggregate(hindcast_1985$preds, 
                 by = list(lat = hindcast_1985$lat_grid025,
                           lon = hindcast_1985$lon_grid025),
                 FUN = mean, na.rm= TRUE)

sum_abundance <- aggregate(hindcast_1985$wtcpue, 
                           by = list(lat = hindcast_1985$lat_grid025,
                                     lon = hindcast_1985$lon_grid025),
                           FUN = mean, na.rm= TRUE)
...
png("roms_figures_output_ver_1/classic_model_predictions_ver_3.png", width=6, height=6, units="in", res=300)
