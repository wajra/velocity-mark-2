# Visualizing Interactions - Part XXII
# Plot the predictions for post 2000 including DFO_Scotian Shelf datapoints
...
post_2000_predictions <- read.csv(file="roms_model_output_ver_1/mi_model_post_2000_predictions_drop_gmex_including_dfo.csv")
...
png("roms_figures_output_ver_1/mi_model_post_2000_true_vs_preds_with_dfo_drop_gmex.png", width=4, height=6, units="in", res=300)
