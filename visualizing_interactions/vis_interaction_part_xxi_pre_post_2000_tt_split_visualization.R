...
post_2000_predictions <- read.csv(file="roms_model_output_ver_1/mi_model_tt_split_version_hindcast.csv")


# We can get the original data for the pre 2000 + 2 survey data from here
