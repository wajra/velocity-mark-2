...
do_2000_files <- Sys.glob(file.path("/Volumes/JB_DRIVE/RESEARCH/ROMS/2000/spring/do", "*.txt"))
temp_2000_files <- Sys.glob(file.path("/Volumes/JB_DRIVE/RESEARCH/ROMS/2000/spring/temperature", "*.txt"))
salinity_2000_files <- Sys.glob(file.path("/Volumes/JB_DRIVE/RESEARCH/ROMS/2000/spring/salinity", "*.txt"))
...
# Now write this out
# Write this matrix
write.table(mi_mean, "/Users/jeewantha/Downloads/mi_2000_spring.txt", col.names=F, row.names=F)
