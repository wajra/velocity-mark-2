...
plot_1 <- ggplot(data = world) +
  ...
  scale_fill_gradientn(colors=c("#ffffcc","#a1dab4","#41b6c4", "#225ea8"),
                       values = scales::rescale(c(0,0.5,1, max(sum_1980$x)))) +  
...
plot_2 <- ggplot(data = world) +
  ...
  scale_fill_gradientn(colors=c("#ffffcc","#a1dab4","#41b6c4", "#225ea8"),
                       values = scales::rescale(c(0,1,2, max(sum_2000$x)))) + 
...
png("roms_figures_output_ver_1/bsb_dist_1990_to_2010_ver_5.png", width=6, height=6, units="in", res=300)
