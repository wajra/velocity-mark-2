...
# hauls <- hauls[!(hauls$region %in% c("SEFSC_GOMex", "VIMS_NEAMAP", "DFO_ScotianShelf", "DFO_SoGulf")),]


################## 2021-04-03 - Removing the VIMS_NEAMAP and GOMEX ###########



# Changed the runname for my own diagnostics
runname <- "metabolic_index_2021_04_05_split_pre_2000_with_all_regions"
...
for(i in 1:length(allspp)){  
  ...
  for(j in 1:length(ninds)){ 
    ...
    #region_subset <- spdata[spdata$regionfact==names(ninds[j]),]
  ...
  if(length(levels(spdata$regionfact))==1){
    ...
    mypresmod<-formula(presfit ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE))
    'Abundance model - If there is only one region'
    myabunmod<-formula(logwtcpue.pad ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE))
    ...
    mypresmod<-formula(presfit ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE) + regionfact)
    myabunmod<-formula(logwtcpue.pad ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE) + regionfact)
  ...
  if(length(abc[abc$reg.pres==TRUE,])==1){
    ...
    mypresmodtt<-formula(presfit ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE))
    myabunmodtt<-formula(logwtcpue.pad ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE))
  } else {
    mypresmodtt<-formula(presfit ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE) + regionfact)
    myabunmodtt<-formula(logwtcpue.pad ~ s(SBT.seasonal) + s(o2_seasonal) + s(mi) + s(zplk_class_mean_seasonal) + s(SST.seasonal.mean) + s(SBT.min) + s(SBT.max) + s(SST.max) + s(rugosity) + s(GRAINSIZE) + regionfact)
  }
  ...
  write.csv(test, file="roms_model_output_ver_1/mi_model_tt_split_version_hindcast_all_regions.csv")
  print("Wrote this!!!")
  ...
  if(fittrain){
    ...
    write.csv(test, file="roms_model_output_ver_1/mi_model_post_2000_predictions_all_regions.csv")
