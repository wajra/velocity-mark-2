...
runname <- "metabolic_index_2021_04_06_split_pre_2000_drop_gmex_including_dfo"
...
for(i in 1:length(allspp)){  
  ...
  write.csv(test, file="roms_model_output_ver_1/mi_model_tt_split_version_hindcast_drop_gmex_including_dfo.csv")
  print("Wrote this!!!")
  ...
  if(fittrain){
    ...
    write.csv(test, file="roms_model_output_ver_1/mi_model_post_2000_predictions_drop_gmex_including_dfo.csv")
